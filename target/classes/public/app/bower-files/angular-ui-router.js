 ...
 * on state.
 *
 * A state corresponds to a "place" in the app in terms of the overall UI and
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
     ...
     * @example
     * <pre>
     * //assuming app app consists of 3 states: 'contacts', 'contacts.detail', 'contacts.detail.item'
